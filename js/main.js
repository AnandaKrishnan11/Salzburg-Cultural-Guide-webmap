...
// your line GeoJSON lives in mwalk.json

L.geoJSON(mywalk).addTo(map);
...
var summits = L.geoJson(summitsJson, {
	...
	onEachFeature: function(feature, marker) {
		marker.bindPopup("Summit:<br><b>" + feature.properties.NAME + "</b><br>" +
...
// create a walk‐layer
var walkLayer = L.geoJSON(mywalk);
